...
### 模块 3：FastAPI 应用架构
- [x] 3.1 分层结构：router、service、repository、schema、model
...
- [x] 2.3 不遮蔽数据库细节的 CRUD 写法 (模块 2：数据库与 SQLAlchemy)
- [x] 2.4 表关系、懒加载/预加载与 N+1 问题 (模块 2：数据库与 SQLAlchemy)
- [ ] 2.5 Alembic 迁移与数据库结构演进 (模块 2：数据库与 SQLAlchemy)
- [ ] 2.6 事务、并发与失败边界 (模块 2：数据库与 SQLAlchemy)
- [x] 3.1 分层结构：router、service、repository、schema、model (模块 3：FastAPI 应用架构)
